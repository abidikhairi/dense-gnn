...
from project.utils.training import train, test
...
def main(args):
    ...
    if args.dataset == 'proteins':
        dataset = datasets.TUDataset(name='PROTEINS_full')
    else:
        dataset = datasets.TUDataset(name=args.dataset.upper())
    ...
    n_feats = 18 if args.dataset == 'enzymes' else 29
    n_classes = dataset.num_classes[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, required=True, help='dataset name', choices=["enzymes", "proteins"])
